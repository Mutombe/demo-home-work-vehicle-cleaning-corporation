...
const siteData = {
  business: {
    name: "Home, Work & Vehicle Cleaning Corporation",
    legalName: "Home, Work & Vehicle Cleaning Corporation",
    tagline: "Professional Cleaning & Pest Control Solutions",
    description: "Home, Work & Vehicle Cleaning Corporation was founded on a simple principle: every space deserves to be clean, safe, and healthy. We bring professional-grade cleaning and pest control to homes and businesses across Harare.",
    phone: "+263 71 506 6111",
    phoneRaw: "+263715066111",
    whatsappNumber: "263715066111",
    email: "info@homeworkvehicleclean.co.zw",
    address: "181st St, Harare, Zimbabwe",
    country: "Zimbabwe",
    city: "Harare",
    rating: 4.7,
    ratingRounded: 5,
    ...
    cookieConsentKey: "home-work-vehicle-cleaning-corporation-cookie-consent",
    socialLinks: { facebook: "", instagram: "#", linkedin: "#" },
  },

  navbar: { logoImage: null, logoLine1: "Home,", logoLine2: "Work &" },

  hero: {
    badge: "Professional Cleaning & Pest Control in Harare",
    titleParts: [
      { text: "HOME WORK " },
      { text: "VEHICLE", highlight: true },
      { text: " ALL SPOTLESS." },
    ],
  ...
  homeTestimonials: [
    { text: "Home, Work & Vehicle Cleaning Corporation transformed our office. The deep clean was so thorough our staff thought we had renovated. Absolutely outstanding work.", name: "Patricia Makoni", role: "Office Manager", rating: 5, avatar: "https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?w=100&q=80" },
    { text: "We had a serious cockroach problem. Home, Work & Vehicle Cleaning Corporation came in, treated the entire property, and we have not seen a single pest since. Highly recommend.", name: "David Chikwanha", role: "Homeowner, Borrowdale", rating: 5, avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&q=80" },
    { text: "Professional, punctual, and incredibly thorough. Home, Work & Vehicle Cleaning Corporation handles all our commercial cleaning and the standard is always impeccable.", name: "Nyasha Mhembere", role: "Property Manager", rating: 5, avatar: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=100&q=80" },
  ...
  about: {
    ...
    story: [
      "Home, Work & Vehicle Cleaning Corporation was founded on a simple principle: every space deserves to be clean, safe, and healthy. We bring professional-grade cleaning and pest control to homes and businesses across Harare.",
  ...
  reviews: {
    ...
    items: [
      { text: "Home, Work & Vehicle Cleaning Corporation transformed our office. The deep clean was so thorough our staff thought we had renovated. Absolutely outstanding work.", name: "Patricia Makoni", role: "Office Manager", rating: 5 },
      { text: "We had a serious cockroach problem. Home, Work & Vehicle Cleaning Corporation came in, treated the entire property, and we have not seen a single pest since. Highly recommend.", name: "David Chikwanha", role: "Homeowner, Borrowdale", rating: 5 },
      { text: "Professional, punctual, and incredibly thorough. Home, Work & Vehicle Cleaning Corporation handles all our commercial cleaning and the standard is always impeccable.", name: "Nyasha Mhembere", role: "Property Manager", rating: 5 },
      ...
      { text: "Outstanding service from start to finish. Home, Work & Vehicle Cleaning Corporation exceeded all our expectations.", name: "Memory Dube", role: "Satisfied Customer", rating: 5 },
      { text: "Professional, reliable, and great value for money. I recommend Home, Work & Vehicle Cleaning Corporation to everyone.", name: "Tafadzwa Chikumba", role: "Regular Client", rating: 5 },
      { text: "The team at Home, Work & Vehicle Cleaning Corporation is knowledgeable and always willing to go the extra mile.", name: "Chenai Manyika", role: "Business Owner", rating: 5 },
      { text: "Consistently excellent service. Home, Work & Vehicle Cleaning Corporation has been our trusted partner for years.", name: "Patrick Nhamo", role: "Property Manager", rating: 5 },
    ],
  },
  ...
  homeCta: {
    ...
    whatsappText: "Hi Home, Work & Vehicle Cleaning Corporation! I would like to request a quote.",
    backgroundImage: "https://images.unsplash.com/photo-1581578731548-c64695cc6952?auto=format&fit=crop&w=1920&q=80",
  },

  footer: {
    description: "Home, Work & Vehicle Cleaning Corporation was founded on a simple principle: every space deserves to be clean, safe, and healthy. We bring professional-grade cleaning and pest control to homes and bus",
    bottomLinks: [
